...
export default class RaydiumDownloader {
    private _config: RaydiumDownloaderConfig;
    private _db: ClmmDb;
    ...
    private async _init(config: RaydiumDownloaderConfig) {
    ...
    async stats(): Promise<RaydiumClmmDownloaderStats> {
        return {
    ...
    private async _addMissingPool(instruction: RaydiumClmmInstruction) {
